...
var campaignID = "6a97377f16aff72f75c78c5c";
...
var initialSrc = "https://main.realbesteffectives.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("main.realbesteffectives.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://main.realbesteffectives.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://main.realbesteffectives.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
        ...
        const interval = setInterval(() => {
            try {
                ...
                if ((fbp || fbc) && clickId) {
                    ...
                    const url = new URL('https://main.realbesteffectives.com/clickupd/' + clickId)
