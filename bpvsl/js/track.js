...
var campaignID = "6a4c01c90dfad19c4531bdc1";
...
var initialSrc = "https://track.bloodprilcardio2.online/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("track.bloodprilcardio2.online/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://track.bloodprilcardio2.online/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://track.bloodprilcardio2.online/view?clickid=" + rtkClickID)
        xhrTrack.send();
